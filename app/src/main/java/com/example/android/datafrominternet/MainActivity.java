...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorMessageTextView = (TextView) findViewById(R.id.tv_error_display_message);
    ...
    private void showJsonDataView(MediaRouteButton mErrorMessageDisplay) {
        mErrorMessageDisplay.setVisibility(View.INVISIBLE);
        mSearchResultsTextView.setVisibility(View.VISIBLE);
    }
    // TODO (15) Create a method called showErrorMessage to show the error and hide the data
    private void showErrorMessage(MediaRouteButton mErrorMessageDisplay) {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            else showErrorMessage(mErrorMessageDisplay);
